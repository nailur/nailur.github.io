-- =====================================
-- PATCH V22: Update process_checkout RPC to include notes
-- =====================================
...
DROP FUNCTION IF EXISTS public.process_checkout(UUID, UUID, NUMERIC, NUMERIC, NUMERIC, NUMERIC, TEXT, TEXT, JSONB, UUID, NUMERIC, NUMERIC);
...
BEGIN
  ...
  INSERT INTO public.transactions (
    ...
    payment_method, customer_name, cash_received, change_amount, notes
  ) VALUES (
    COALESCE(p_id, gen_random_uuid()),
    p_outlet_id, p_cashier_id,
    p_subtotal_amount, p_discount_amount, p_tax_amount, p_total_amount,
    p_payment_method, p_customer_name, p_cash_received, p_change_amount, p_notes
